...
const en = {
  ...
  "settings.tab.agents": "Agent access",
  ...
  "settings.agents.automation": "Scan automation",
  "settings.agents.automation.desc": "These settings are shared with Memmy Desktop → Cross-Agent access.",
  ...
  "settings.agents.autoConnect.desc": "Install the appropriate plugin, hook, or skill when a supported Agent is detected.",
  "settings.agents.sources": "Cross-Agent sources",
  "settings.agents.sources.desc": "Connect and scan every Agent supported by Memmy, not only OpenClaw and Hermes.",
  ...
  "settings.agents.memoryCount": "{n} imported messages",
  "settings.agents.noData": "No local history detected",
  "settings.agents.scanQueued": "Scan queued. Results will appear as the scan progresses.",
  "settings.agents.executorOffline": "Memmy Desktop is not running. Settings remain available, but local history scanning and connection changes require the Desktop scan executor.",
...
const zh: Record<TranslationKey, string> = {
  ...
  "worldModels.lightweight.empty":
    "当前仅保存基础摘要记忆。启用记忆自进化后，系统会自动建立场域认知。",
  ...
  "settings.tab.agents": "跨 Agent 接入",
  ...
  "settings.general.lightweightMemory.desc":
    "在基础摘要记忆之外，自动沉淀任务、经验、场域认知和技能。会调用更多模型能力，适合重度记忆使用场景。保存并重启后生效。",
  "settings.general.detailedLogs": "显示详细调试日志",
  "settings.general.detailedLogs.desc":
    "开启后显示链路视图、仅看失败筛选，以及任务、经验、技能、场域认知和系统日志分类。",
  "settings.general.telemetry": "启用匿名数据统计",
  "settings.general.telemetry.desc":
    "仅收集工具名称、响应时间和版本号，不涉及任何记忆内容或个人数据。",
  "settings.agents.automation": "扫描自动化",
  "settings.agents.automation.desc": "这里的设置与 Memmy Desktop → 跨 Agent 接入共用同一份配置。",
  ...
  "settings.agents.autoConnect.desc": "检测到支持的 Agent 后，自动安装相应的插件、Hook 或 Skill。",
  "settings.agents.sources": "跨 Agent 数据源",
  "settings.agents.sources.desc": "接入并扫描 Memmy 支持的所有 Agent，不再只限于 OpenClaw 和 Hermes。",
  ...
  "settings.agents.memoryCount": "已导入 {n} 条消息",
  "settings.agents.noData": "未检测到本地会话数据",
  "settings.agents.scanQueued": "扫描任务已提交，结果会随扫描进度更新。",
  "settings.agents.executorOffline": "Memmy Desktop 当前未运行。扫描设置仍可修改，但本地历史扫描和接入操作需要 Desktop 扫描执行器。",
