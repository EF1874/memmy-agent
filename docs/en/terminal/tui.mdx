...
- Whether `/history-dag`  appears depends on whether the corresponding features are enabled.
...
Whether commands such as `/history-dag`  are available depends on whether the corresponding features are enabled in your configuration.
