...
| 千问办公 | `~/.qwenworkcn/projects/**/*.jsonl` | Skill（按需调用记忆） |
...
| 千问办公 | Skill | Agent 主动调用 `memmy-memory` | 按需搜索、读取和写入共享记忆 |
...
1. 打开 **记忆管理 → 跨Agent接入**。
2. Cursor、Claude Code、Codex 点击 **安装 Hook**；OpenCode、OpenClaw、Hermes 点击 **安装插件**；WorkBuddy、Pi、千问办公点击 **安装 Skill**。
